---
title: "Machine Learning Course - Week 4 Project"
...
confMatRF
```
The accuracy is 99.68% (>99%) and predicted accuracy for the out-of-sample error is 0.28%, So Random Forests alogorithm can be used to predict the test set.
